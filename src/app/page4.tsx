    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="flex-1 px-8 py-6">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-black mb-4">Register as Hospice</h2>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="address" className="text-gray-600 font-normal text-sm min-w-[60px]">
                    Address
                  </Label>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Label htmlFor="phone" className="text-gray-600 font-normal text-sm min-w-[60px]">
                    Phone
                  </Label>
